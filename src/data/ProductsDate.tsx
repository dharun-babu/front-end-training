...
import WristWatch from "../assets/image/pexels-pixabay-277319.jpg";
...
const Products = [
    ...
    { id: 4, name: 'OverHead', price: 40, image: OverHead },
    { id: 5, name: 'OverHead', price: 40, image: OverHead },
    { id: 6, name: 'OverHead', price: 40, image: OverHead },
